    ...
    void Update()
    {
        ...
        if (SpawnTimer > 0.6f)
        {
            ...
            if (o != null)
            {
                ...
                var spawnpoint = node.transform.position + new Vector3(0, 70, 40);
            ...
            foreach (var d in deletePods)
            {
                deletePods.TryDequeue(out _);
                var gm = GameObject.Find(d.Object.metadata.name);
                Destroy(gm);
            }
        }
